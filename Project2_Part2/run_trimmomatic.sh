...
unpaired_output_1="  # where the reads that do not pass the filtering in both R1 and R2 go 

output_2="CcoxCrh_comrhy62_EO_6cm_1_2_trimmed.fastq.gz"

/usr/bin/time -v pixi run trimmomatic PE -threads 8 $input_1 $input_2 $output_1 $output_2 LEADING 3 TRAILING 3 SLIDINGWINDOW 5:15 MINLEN 35