...
/usr/bin/time -v pixi run trimmomatic -Xmx16g PE -threads 16 $input_1 $input_2 $paired_output_1 $unpaired_output_1 $paired_output_2 $unpaired_output_2 LEADING:3 TRAILING:3 SLIDINGWINDOW:5:15 MINLEN:35